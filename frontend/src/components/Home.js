...
import { GEOLOCATION_OPTIONS, POSITION_KEY, API_ROOT, AUTH_HEADER, TOKEN_KEY } from '../constants';
...
export class Home extends React.Component {
    ...
    getGeolocation() {
        ...
        if ('geolocation' in navigator) {
            navigator.geolocation.getCurrentPosition(
                this.onGeolocationSuccess,  //call back function
    ...
    onGeolocationSuccess = (position) => {  //lamda function automatic bind (this.) get geolocation
        this.setState({  //
            loadingGeolocation: false,
            errorMessage: null,
        })
