...
//
//     onToggleOpen = () => {
//         this.setState(({ isOpen }) => ({ //get previous state
//             isOpen: !isOpen, //set to current state as opposite
//         }))
//     }
//
//     render() {
...
//                     onMouseOver={this.onToggleOpen} //move mouse to display
//                     onMouseOut={this.onToggleOpen}
//                 >
//                     {(
//                         this.state.isOpen ?  //click to open and close
//                             (
